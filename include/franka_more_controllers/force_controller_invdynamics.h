...
class ForceControllerInvDynamics : public controller_interface::MultiInterfaceController<
 ...
 private:
  ros::Subscriber sub_forcetorque_sensor;
  // Saturation
  ...
  std::string which_axis;
  double desired_force_torque_value;
  int axis;
